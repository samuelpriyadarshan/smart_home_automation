...
// for ZYBO
var SERVER_URL = "http://192.168.1.2:8080/"
	...
	callApi(
		...
		function (o) {
			...
			if (retJson.temp){
				...
				document.getElementById("output").innerHTML = retJson.temp;
				document.getElementById("output").value = retJson.temp
			}
